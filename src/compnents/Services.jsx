    ...
    <Section id="how-to-use">
     <div className="container">
        ...
        <div className="relative">
            <div className="relative z-1 flex items-center h-[39rem] mb-5 pb-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] ">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
                <img src={service1}  className="w-full h-full object-cover md:object-right " width={800} height={730} alt="services" />
            </div>
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/4 lg-right-auto lg:right-1/4 lg:bottom-8 lg:-translate-x-1/2"/>
            </div>
            <div className="relative z-1 grid gap-5 lg:grid-cols-2">
               <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
                ...
                <p className="body-2 mb-[3rem] text-n-3">Automatically enhance your photos using our App&apos;s AI photo editing feature. Try it now!</p>
                </div>
                <PhotoChatMessage />
               </div>
               <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:mid-h-[46rem]">
